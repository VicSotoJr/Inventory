...
<!-- Nav Bar -->
       <nav class="navbar navbar-expand-sm bg-dark navbar-dark navbar-fixed-top">
         ...
         <?php
/* Displays all of the items in a table with areaID as Cooler */
                $query = "SELECT ID,itemID,itemName,pack,size,price,areaID,quantity FROM items where areaID = 'C'";
               ...
               while($row = mysqli_fetch_array($result)){
                    ...
                    echo "<tr><td>" . $row['itemID'] . "</td><td>" . $row['itemName'] . "</td><td>" . $row['pack'] . "</td>"
                            ...
                            ."<form action='cooler.php' method='post' onsubmit='parent.window.location.reload(false)'>"
