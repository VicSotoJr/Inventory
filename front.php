...
<!-- Nav Bar -->
         ...
         <?php
/* Displays all of the items in a table with areaID as front */
                $query = "SELECT ID,itemID,itemName,pack,size,price,areaID,quantity FROM items where areaID = 'F'";
               ...
               while($row = mysqli_fetch_array($result)){
                    ...
                    echo "<tr><td>" . $row['itemID'] . "</td><td>" . $row['itemName'] . "</td><td>" . $row['pack'] . "</td>"
                            ...
                            ."<form action='front.php' method='post' onsubmit='parent.window.location.reload(false)'>"
